...
Sprites are top-down, nose up, cropped to the hull (image height = base
length), 8-bit RGBA PNG.

| File | Origin | License |
|------|--------|---------|
| tie-fighter.png, xwing-t70.png | added 2026-08-29 (origin to be confirmed by B Cluts) | MIT OR Apache-2.0 (repo license) |
| y-wing.png | public-domain render found by B Cluts (2026-09-04); rotated, cropped and downscaled here | public domain / no copyright per the source page |
